...
class $AssetsImagesSplashGen {
  ...
  /// File path: assets/images/splash/splash_otter.png
  AssetGenImage get splashOtter =>
      const AssetGenImage('assets/images/splash/splash_otter.png');

  /// List of all assets
  List<AssetGenImage> get values => [splashOtter];
}
