...
class GiftRepository {
  ...
  Future<Gift> add({
    ...
    await _db.into(_db.gifts).insert(GiftsCompanion.insert(
      ...
      givenGiftPrice: Value(givenGiftPrice),
      receivedGiftName: Value(receivedGiftName),
      receivedGiftPrice: Value(receivedGiftPrice),
      memo: Value(memo),
      createdAt: now,
      updatedAt: now,
    ));
  ...
  Future<Gift?> update(Gift gift) async {
    ...
    await (_db.update(_db.gifts)..where((t) => t.id.equals(updated.id)))
      ...
      givenGiftPrice: Value(updated.givenGiftPrice),
      receivedGiftName: Value(updated.receivedGiftName),
      receivedGiftPrice: Value(updated.receivedGiftPrice),
  ...
  Gift _fromRow(GiftData row) {
    return Gift(
      ...
      givenGiftPrice: row.givenGiftPrice,
      receivedGiftName: row.receivedGiftName,
      receivedGiftPrice: row.receivedGiftPrice,
      memo: row.memo,
